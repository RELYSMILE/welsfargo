...
const LoginNav = ({isNavBgVisible, homeId}) => {
  ...
  return<>
    <div className={isNavBgVisible? 'navigation-parent-container navigation-parent-container-window-scroll' : 'navigation-parent-container-login'}>
      <Link to='/' target='_top'>
